...
export const PostInternalSubmitRequest = Schema.Struct({})
  .pipe(T.Http({ method: "POST", path: "/internal/submit" }))
  .annotations({
    identifier: "PostInternalSubmitRequest",
  }) as unknown as Schema.Schema<PostInternalSubmitRequest>;
...
export const PostInternalSubmitResponse = Schema.Struct({
  ...
  identifier: "PostInternalSubmitResponse",
}) as unknown as Schema.Schema<PostInternalSubmitResponse>;
