...
export const OrganizationListorganizationsRequest = Schema.Struct({})
  ...
  .annotations({
    identifier: "OrganizationListorganizationsRequest",
  }) as unknown as Schema.Schema<OrganizationListorganizationsRequest>;
...
export const OrganizationListorganizationsResponse = Schema.Struct({
  ...
  identifier: "OrganizationListorganizationsResponse",
}) as unknown as Schema.Schema<OrganizationListorganizationsResponse>;
...
export const OrganizationsCreateuserorganizationRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "OrganizationsCreateuserorganizationRequest",
  }) as unknown as Schema.Schema<OrganizationsCreateuserorganizationRequest>;
...
export const OrganizationsCreateuserorganizationResponse = Schema.Struct({
  ...
  identifier: "OrganizationsCreateuserorganizationResponse",
}) as unknown as Schema.Schema<OrganizationsCreateuserorganizationResponse>;
...
export const OrganizationsRetrieveRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "OrganizationsRetrieveRequest",
  }) as unknown as Schema.Schema<OrganizationsRetrieveRequest>;
...
export const OrganizationsRetrieveResponse = Schema.Struct({
  ...
  identifier: "OrganizationsRetrieveResponse",
}) as unknown as Schema.Schema<OrganizationsRetrieveResponse>;
...
export const OrganizationsModifyRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "PUT", path: "/organizations/{organization_id}" }))
  .annotations({
    identifier: "OrganizationsModifyRequest",
  }) as unknown as Schema.Schema<OrganizationsModifyRequest>;
...
export const OrganizationsModifyResponse = Schema.Struct({
  ...
  identifier: "OrganizationsModifyResponse",
}) as unknown as Schema.Schema<OrganizationsModifyResponse>;
...
export const OrganizationsGetaccountsRequest = Schema.Struct({
  ...
  "account_pubname.startsWith": Schema.optional(Schema.String).pipe(
    T.HttpQuery("account_pubname.startsWith"),
  ),
  "account_pubname.endsWith": Schema.optional(Schema.String).pipe(
    T.HttpQuery("account_pubname.endsWith"),
  ),
  "account_pubname.contains": Schema.optional(Schema.String).pipe(
    T.HttpQuery("account_pubname.contains"),
  ),
  ...
  .pipe(T.Http({ method: "GET", path: "/organizations/{organization_id}/accounts" }))
  .annotations({
    identifier: "OrganizationsGetaccountsRequest",
  }) as unknown as Schema.Schema<OrganizationsGetaccountsRequest>;
...
export const OrganizationsGetaccountsResponse = Schema.Struct({
  ...
  identifier: "OrganizationsGetaccountsResponse",
}) as unknown as Schema.Schema<OrganizationsGetaccountsResponse>;
...
export const ListRequest = Schema.Struct({
  organization_id: Schema.String.pipe(T.HttpPath("organization_id")),
  status: Schema.optional(Schema.Array(Schema.Literal("active", "canceled"))).pipe(
    T.HttpQuery("status"),
  ),
  ...
  "user.email.startsWith": Schema.optional(Schema.String).pipe(
    T.HttpQuery("user.email.startsWith"),
  ),
  "user.email.endsWith": Schema.optional(Schema.String).pipe(T.HttpQuery("user.email.endsWith")),
})
  .pipe(T.Http({ method: "GET", path: "/organizations/{organization_id}/members" }))
...
export interface ListResponse {
  result: {
    ...
    status: "active" | "canceled";
    update_time: string;
    user: { email: string; id: string; name: string; two_factor_authentication_enabled: boolean };
  }[];
  result_info?: {
    page?: number;
    per_page?: number;
...
export const CreateRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/organizations/{organization_id}/members" }))
...
export const MembersRetrieveRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/organizations/{organization_id}/members/{member_id}" }))
  .annotations({
    identifier: "MembersRetrieveRequest",
  }) as unknown as Schema.Schema<MembersRetrieveRequest>;
...
export const MembersRetrieveResponse = Schema.Struct({
  ...
  identifier: "MembersRetrieveResponse",
}) as unknown as Schema.Schema<MembersRetrieveResponse>;
...
export const Delete_1Request = Schema.Struct({
  ...
  .pipe(T.Http({ method: "DELETE", path: "/organizations/{organization_id}/members/{member_id}" }))
...
export const MembersBatchcreateRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/organizations/{organization_id}/members:batchCreate" }))
  .annotations({
    identifier: "MembersBatchcreateRequest",
  }) as unknown as Schema.Schema<MembersBatchcreateRequest>;
...
export const MembersBatchcreateResponse = Schema.Struct({
  ...
  identifier: "MembersBatchcreateResponse",
}) as unknown as Schema.Schema<MembersBatchcreateResponse>;
...
export const OrganizationsGetprofileRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/organizations/{organization_id}/profile" }))
  .annotations({
    identifier: "OrganizationsGetprofileRequest",
  }) as unknown as Schema.Schema<OrganizationsGetprofileRequest>;
...
export const OrganizationsGetprofileResponse = Schema.Struct({
  ...
  identifier: "OrganizationsGetprofileResponse",
}) as unknown as Schema.Schema<OrganizationsGetprofileResponse>;
...
export const OrganizationsModifyprofileRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "PUT", path: "/organizations/{organization_id}/profile" }))
  .annotations({
    identifier: "OrganizationsModifyprofileRequest",
  }) as unknown as Schema.Schema<OrganizationsModifyprofileRequest>;
...
export const OrganizationsModifyprofileResponse = Schema.Struct({
  ...
  identifier: "OrganizationsModifyprofileResponse",
}) as unknown as Schema.Schema<OrganizationsModifyprofileResponse>;
...
export const List1Request = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/organizations/{organization_id}/shares" }))
