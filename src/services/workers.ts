...
export interface GetScriptBindingsResponse {
  result: (
    ...
    | { name: string; old_name?: string; type: "inherit"; version_id?: string }
    | { name: string; type: "images" }
    | { json: string; name: string; type: "json" }
    | { name: string; namespace_id: string; type: "kv_namespace" }
    | { certificate_id: string; name: string; type: "mtls_certificate" }
    | { name: string; text: string; type: "plain_text" }
    | { name: string; pipeline: string; type: "pipelines" }
    | { name: string; queue_name: string; type: "queue" }
    | { bucket_name: string; jurisdiction?: "eu" | "fedramp"; name: string; type: "r2_bucket" }
    ...
    | { environment?: string; name: string; service: string; type: "service" }
    | { name: string; part: string; type: "text_blob" }
    | { index_name: string; name: string; type: "vectorize" }
    | { name: string; type: "version_metadata" }
    | { name: string; secret_name: string; store_id: string; type: "secrets_store_secret" }
    | {
        algorithm: Record<string, unknown>;
        format: "raw" | "pkcs8" | "spki" | "jwk";
        key_base64?: string;
        key_jwk?: Record<string, unknown>;
        name: string;
        type: "secret_key";
        usages: (
          | "encrypt"
      ...
      Schema.NullOr(
        Schema.Array(
          Schema.Union(
            ...
            Schema.Struct({
              allowed_destination_addresses: Schema.optional(
          ...
          Schema.Array(
            Schema.Union(
              ...
              Schema.Struct({
                ...
                allowed_sender_addresses: Schema.optional(
                  Schema.NullOr(Schema.Array(Schema.String)),
                ),
                destination_address: Schema.optional(Schema.NullOr(Schema.String)),
                name: Schema.String,
