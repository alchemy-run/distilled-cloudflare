...
export class NamespaceNotFound extends Schema.TaggedError<NamespaceNotFound>()("NamespaceNotFound", {
  code: Schema.Number,
  message: Schema.String,
}).pipe(C.withNotFoundError) {
...
export const deleteScripts: (
  ...
  RateLimited | TooManyRequests | AuthenticationError | InvalidToken | MissingToken | TokenExpired | Unauthorized | WorkerNotFound | ValidationError | CloudflareError | UnknownCloudflareError | CloudflareNetworkError | CloudflareHttpError,
  ApiToken | HttpClient.HttpClient
> = API.make(() => ({
  input: DeleteScriptsRequest,
  output: DeleteScriptsResponse,
  errors: [RateLimited.pipe(T.HttpErrorCode(971)), TooManyRequests.pipe(T.HttpErrorCode(6100)), AuthenticationError.pipe(T.HttpErrorCode(10000)), InvalidToken.pipe(T.HttpErrorCode(9103)), MissingToken.pipe(T.HttpErrorCode(9106)), TokenExpired.pipe(T.HttpErrorCode(9109)), Unauthorized.pipe(T.HttpErrorCode(9000)), WorkerNotFound.pipe(T.HttpErrorCode(10007), T.HttpErrorStatus(404)), ValidationError.pipe(T.HttpErrorCode(10021))],
}));
...
export const namespaceWorkerScriptWorkerDetails: (
  ...
  RateLimited | TooManyRequests | AuthenticationError | InvalidToken | MissingToken | TokenExpired | Unauthorized | NamespaceNotFound | WorkerNotFound | CloudflareError | UnknownCloudflareError | CloudflareNetworkError | CloudflareHttpError,
  ApiToken | HttpClient.HttpClient
> = API.make(() => ({
  input: NamespaceWorkerScriptWorkerDetailsRequest,
  output: NamespaceWorkerScriptWorkerDetailsResponse,
  errors: [RateLimited.pipe(T.HttpErrorCode(971)), TooManyRequests.pipe(T.HttpErrorCode(6100)), AuthenticationError.pipe(T.HttpErrorCode(10000)), InvalidToken.pipe(T.HttpErrorCode(9103)), MissingToken.pipe(T.HttpErrorCode(9106)), TokenExpired.pipe(T.HttpErrorCode(9109)), Unauthorized.pipe(T.HttpErrorCode(9000)), NamespaceNotFound.pipe(T.HttpErrorCode(100119), T.HttpErrorStatus(404)), WorkerNotFound.pipe(T.HttpErrorCode(10007), T.HttpErrorStatus(404))],
}));
...
export const namespaceWorkerScriptUploadWorkerModule: (
  ...
  RateLimited | TooManyRequests | AuthenticationError | InvalidToken | MissingToken | TokenExpired | Unauthorized | NamespaceNotFound | InvalidWorkerName | NoEventHandlers | ValidationError | CloudflareError | UnknownCloudflareError | CloudflareNetworkError | CloudflareHttpError,
  ApiToken | HttpClient.HttpClient
> = API.make(() => ({
  input: NamespaceWorkerScriptUploadWorkerModuleRequest,
  output: NamespaceWorkerScriptUploadWorkerModuleResponse,
  errors: [RateLimited.pipe(T.HttpErrorCode(971)), TooManyRequests.pipe(T.HttpErrorCode(6100)), AuthenticationError.pipe(T.HttpErrorCode(10000)), InvalidToken.pipe(T.HttpErrorCode(9103)), MissingToken.pipe(T.HttpErrorCode(9106)), TokenExpired.pipe(T.HttpErrorCode(9109)), Unauthorized.pipe(T.HttpErrorCode(9000)), NamespaceNotFound.pipe(T.HttpErrorCode(100119), T.HttpErrorStatus(404)), InvalidWorkerName.pipe(T.HttpErrorCode(10016)), NoEventHandlers.pipe(T.HttpErrorCode(10068)), ValidationError.pipe(T.HttpErrorCode(10021))],
}));
...
export interface GetScriptBindingsResponse {
  result: ({ name: string; type: "ai" } | { dataset: string; name: string; type: "analytics_engine" } | { name: string; type: "assets" } | { name: string; type: "browser" } | { id: string; name: string; type: "d1" } | { name: string; part: string; type: "data_blob" } | { name: string; namespace: string; outbound?: { params?: string[]; worker?: { environment?: string; service?: string } }; type: "dispatch_namespace" } | { class_name?: string; environment?: string; name: string; namespace_id?: unknown; script_name?: string; type: "durable_object_namespace" } | { id: string; name: string; type: "hyperdrive" } | { name: string; old_name?: string; type: "inherit"; version_id?: string } | { name: string; type: "images" } | { json: string; name: string; type: "json" } | { name: string; namespace_id: string; type: "kv_namespace" } | { certificate_id: string; name: string; type: "mtls_certificate" } | { name: string; text: string; type: "plain_text" } | { name: string; pipeline: string; type: "pipelines" } | { name: string; queue_name: string; type: "queue" } | { bucket_name: string; jurisdiction?: "eu" | "fedramp"; name: string; type: "r2_bucket" } | { name: string; text: string; type: "secret_text" } | { allowed_destination_addresses?: string[]; allowed_sender_addresses?: string[]; destination_address?: string; name: string; type: "send_email" } | { environment?: string; name: string; service: string; type: "service" } | { name: string; part: string; type: "text_blob" } | { index_name: string; name: string; type: "vectorize" } | { name: string; type: "version_metadata" } | { name: string; secret_name: string; store_id: string; type: "secrets_store_secret" } | { algorithm: Record<string, unknown>; format: "raw" | "pkcs8" | "spki" | "jwk"; key_base64?: string; key_jwk?: Record<string, unknown>; name: string; type: "secret_key"; usages: ("encrypt" | "decrypt" | "sign" | "verify" | "deriveKey" | "deriveBits" | "wrapKey" | "unwrapKey")[] } | { class_name?: string; name: string; script_name?: string; type: "workflow"; workflow_name: string } | { name: string; part: string; type: "wasm_module" })[];
  result_info?: { page?: number; per_page?: number; count?: number; total_count?: number; cursor?: string };
}
...
export const GetScriptBindingsResponse = Schema.Struct({
  ...
  outbound: Schema.optional(Schema.NullOr(Schema.Struct({
  params: Schema.optional(Schema.NullOr(Schema.Array(Schema.String))),
  worker: Schema.optional(Schema.NullOr(Schema.Struct({
  ...
  class_name: Schema.optional(Schema.NullOr(Schema.String)),
  environment: Schema.optional(Schema.NullOr(Schema.String)),
  name: Schema.String,
  namespace_id: Schema.optional(Schema.NullOr(Schema.String)),
  ...
  name: Schema.String,
  old_name: Schema.optional(Schema.NullOr(Schema.String)),
  ...
  allowed_destination_addresses: Schema.optional(Schema.NullOr(Schema.Array(Schema.String))),
  allowed_sender_addresses: Schema.optional(Schema.NullOr(Schema.Array(Schema.String))),
  destination_address: Schema.optional(Schema.NullOr(Schema.String)),
  name: Schema.String,
  ...
  key_base64: Schema.optional(Schema.NullOr(Schema.String)),
  key_jwk: Schema.optional(Schema.NullOr(Schema.Struct({}))),
  name: Schema.String,
  type: Schema.Literal("secret_key"),
  usages: Schema.Array(Schema.Literal("encrypt", "decrypt", "sign", "verify", "deriveKey", "deriveBits", "wrapKey", "unwrapKey"))
}), Schema.Struct({
  class_name: Schema.optional(Schema.NullOr(Schema.String)),
  name: Schema.String,
  script_name: Schema.optional(Schema.NullOr(Schema.String)),
...
export interface ListScriptSecretsResponse {
  result: ({ name: string; text: string; type: "secret_text" } | { algorithm: Record<string, unknown>; format: "raw" | "pkcs8" | "spki" | "jwk"; key_base64?: string; key_jwk?: Record<string, unknown>; name: string; type: "secret_key"; usages: ("encrypt" | "decrypt" | "sign" | "verify" | "deriveKey" | "deriveBits" | "wrapKey" | "unwrapKey")[] })[];
  result_info?: { page?: number; per_page?: number; count?: number; total_count?: number; cursor?: string };
}
...
export interface PutScriptSecretsRequest {
  ...
  dispatch_namespace: string;
  script_name: string;
  body: { name: string; text: string; type: "secret_text" } | { algorithm: Record<string, unknown>; format: "raw" | "pkcs8" | "spki" | "jwk"; key_base64?: string; key_jwk?: Record<string, unknown>; name: string; type: "secret_key"; usages: ("encrypt" | "decrypt" | "sign" | "verify" | "deriveKey" | "deriveBits" | "wrapKey" | "unwrapKey")[] };
}
...
export const GetScriptSettingsResponse = Schema.Struct({
  result: Schema.Struct({
  bindings: Schema.optional(Schema.NullOr(Schema.Array(Schema.Union(Schema.Struct({
  name: Schema.String,
  type: Schema.Literal("ai")
}), Schema.Struct({
  dataset: Schema.String,
...
export const patchScriptSettings: (
  ...
  RateLimited | TooManyRequests | AuthenticationError | InvalidToken | MissingToken | TokenExpired | Unauthorized | NamespaceNotFound | WorkerNotFound | ValidationError | BindingNotFound | BindingNameRequired | CloudflareError | UnknownCloudflareError | CloudflareNetworkError | CloudflareHttpError,
  ApiToken | HttpClient.HttpClient
> = API.make(() => ({
  input: PatchScriptSettingsRequest,
  output: PatchScriptSettingsResponse,
  errors: [RateLimited.pipe(T.HttpErrorCode(971)), TooManyRequests.pipe(T.HttpErrorCode(6100)), AuthenticationError.pipe(T.HttpErrorCode(10000)), InvalidToken.pipe(T.HttpErrorCode(9103)), MissingToken.pipe(T.HttpErrorCode(9106)), TokenExpired.pipe(T.HttpErrorCode(9109)), Unauthorized.pipe(T.HttpErrorCode(9000)), NamespaceNotFound.pipe(T.HttpErrorCode(100119), T.HttpErrorStatus(404)), WorkerNotFound.pipe(T.HttpErrorCode(10007), T.HttpErrorStatus(404)), ValidationError.pipe(T.HttpErrorCode(10021)), BindingNotFound.pipe(T.HttpErrorCode(10056)), BindingNameRequired.pipe(T.HttpErrorCode(10052))],
}));
...
export const putScriptTags: (
  ...
  RateLimited | TooManyRequests | AuthenticationError | InvalidToken | MissingToken | TokenExpired | Unauthorized | NamespaceNotFound | WorkerNotFound | ValidationError | CloudflareError | UnknownCloudflareError | CloudflareNetworkError | CloudflareHttpError,
  ApiToken | HttpClient.HttpClient
> = API.make(() => ({
  input: PutScriptTagsRequest,
  output: PutScriptTagsResponse,
  errors: [RateLimited.pipe(T.HttpErrorCode(971)), TooManyRequests.pipe(T.HttpErrorCode(6100)), AuthenticationError.pipe(T.HttpErrorCode(10000)), InvalidToken.pipe(T.HttpErrorCode(9103)), MissingToken.pipe(T.HttpErrorCode(9106)), TokenExpired.pipe(T.HttpErrorCode(9109)), Unauthorized.pipe(T.HttpErrorCode(9000)), NamespaceNotFound.pipe(T.HttpErrorCode(100119), T.HttpErrorStatus(404)), WorkerNotFound.pipe(T.HttpErrorCode(10007), T.HttpErrorStatus(404)), ValidationError.pipe(T.HttpErrorCode(10021))],
}));
...
export const WorkerScriptDownloadWorkerResponse = Schema.instanceOf(FormData).pipe(
  T.HttpMultipartResponse(),
...
export const workerScriptDownloadWorker: (
  ...
  RateLimited | TooManyRequests | AuthenticationError | InvalidToken | MissingToken | TokenExpired | Unauthorized | WorkerNotFound | CloudflareError | UnknownCloudflareError | CloudflareNetworkError | CloudflareHttpError,
  ApiToken | HttpClient.HttpClient
> = API.make(() => ({
  input: WorkerScriptDownloadWorkerRequest,
  output: WorkerScriptDownloadWorkerResponse,
  errors: [RateLimited.pipe(T.HttpErrorCode(971)), TooManyRequests.pipe(T.HttpErrorCode(6100)), AuthenticationError.pipe(T.HttpErrorCode(10000)), InvalidToken.pipe(T.HttpErrorCode(9103)), MissingToken.pipe(T.HttpErrorCode(9106)), TokenExpired.pipe(T.HttpErrorCode(9109)), Unauthorized.pipe(T.HttpErrorCode(9000)), WorkerNotFound.pipe(T.HttpErrorCode(10007), T.HttpErrorStatus(404))],
}));
...
export const workerScriptUploadWorkerModule: (
  ...
  RateLimited | TooManyRequests | AuthenticationError | InvalidToken | MissingToken | TokenExpired | Unauthorized | InvalidWorkerName | WorkerSizeLimitExceeded | ValidationError | NoEventHandlers | UnsupportedEventHandlers | CloudflareError | UnknownCloudflareError | CloudflareNetworkError | CloudflareHttpError,
  ApiToken | HttpClient.HttpClient
> = API.make(() => ({
  input: WorkerScriptUploadWorkerModuleRequest,
  output: WorkerScriptUploadWorkerModuleResponse,
  errors: [RateLimited.pipe(T.HttpErrorCode(971)), TooManyRequests.pipe(T.HttpErrorCode(6100)), AuthenticationError.pipe(T.HttpErrorCode(10000)), InvalidToken.pipe(T.HttpErrorCode(9103)), MissingToken.pipe(T.HttpErrorCode(9106)), TokenExpired.pipe(T.HttpErrorCode(9109)), Unauthorized.pipe(T.HttpErrorCode(9000)), InvalidWorkerName.pipe(T.HttpErrorCode(10016)), WorkerSizeLimitExceeded.pipe(T.HttpErrorCode(10027)), ValidationError.pipe(T.HttpErrorCode(10021)), NoEventHandlers.pipe(T.HttpErrorCode(10068)), UnsupportedEventHandlers.pipe(T.HttpErrorCode(10069))],
}));
...
export const putContent: (
  ...
  PutContentResponse,
  RateLimited | TooManyRequests | AuthenticationError | InvalidToken | MissingToken | TokenExpired | Unauthorized | InvalidWorkerName | NoEventHandlers | ValidationError | CloudflareError | UnknownCloudflareError | CloudflareNetworkError | CloudflareHttpError,
  ApiToken | HttpClient.HttpClient
> = API.make(() => ({
  input: PutContentRequest,
  output: PutContentResponse,
  errors: [RateLimited.pipe(T.HttpErrorCode(971)), TooManyRequests.pipe(T.HttpErrorCode(6100)), AuthenticationError.pipe(T.HttpErrorCode(10000)), InvalidToken.pipe(T.HttpErrorCode(9103)), MissingToken.pipe(T.HttpErrorCode(9106)), TokenExpired.pipe(T.HttpErrorCode(9109)), Unauthorized.pipe(T.HttpErrorCode(9000)), InvalidWorkerName.pipe(T.HttpErrorCode(10016)), NoEventHandlers.pipe(T.HttpErrorCode(10068)), ValidationError.pipe(T.HttpErrorCode(10021))],
}));
...
export const GetContentResponse = Schema.instanceOf(FormData).pipe(
  T.HttpMultipartResponse(),
...
export interface CreateDeploymentRequest {
  ...
  script_name: string;
  force?: boolean;
  body: { strategy: "percentage"; versions: { version_id: string; percentage: number }[]; annotations?: { "workers/message"?: string; "workers/triggered_by"?: string }; author_email?: string };
}
...
export const patchSettings1: (
  ...
  RateLimited | TooManyRequests | AuthenticationError | InvalidToken | MissingToken | TokenExpired | Unauthorized | WorkerNotFound | ValidationError | BindingNotFound | BindingNameRequired | CloudflareError | UnknownCloudflareError | CloudflareNetworkError | CloudflareHttpError,
  ApiToken | HttpClient.HttpClient
> = API.make(() => ({
  input: PatchSettings1Request,
  output: PatchSettings1Response,
  errors: [RateLimited.pipe(T.HttpErrorCode(971)), TooManyRequests.pipe(T.HttpErrorCode(6100)), AuthenticationError.pipe(T.HttpErrorCode(10000)), InvalidToken.pipe(T.HttpErrorCode(9103)), MissingToken.pipe(T.HttpErrorCode(9106)), TokenExpired.pipe(T.HttpErrorCode(9109)), Unauthorized.pipe(T.HttpErrorCode(9000)), WorkerNotFound.pipe(T.HttpErrorCode(10007), T.HttpErrorStatus(404)), ValidationError.pipe(T.HttpErrorCode(10021)), BindingNotFound.pipe(T.HttpErrorCode(10056)), BindingNameRequired.pipe(T.HttpErrorCode(10052))],
}));
...
export const workerVersionsUploadVersion: (
  ...
  RateLimited | TooManyRequests | AuthenticationError | InvalidToken | MissingToken | TokenExpired | Unauthorized | WorkerNotFound | NoEventHandlers | ValidationError | CloudflareError | UnknownCloudflareError | CloudflareNetworkError | CloudflareHttpError,
  ApiToken | HttpClient.HttpClient
> = API.make(() => ({
  input: WorkerVersionsUploadVersionRequest,
  output: WorkerVersionsUploadVersionResponse,
  errors: [RateLimited.pipe(T.HttpErrorCode(971)), TooManyRequests.pipe(T.HttpErrorCode(6100)), AuthenticationError.pipe(T.HttpErrorCode(10000)), InvalidToken.pipe(T.HttpErrorCode(9103)), MissingToken.pipe(T.HttpErrorCode(9106)), TokenExpired.pipe(T.HttpErrorCode(9109)), Unauthorized.pipe(T.HttpErrorCode(9000)), WorkerNotFound.pipe(T.HttpErrorCode(10007), T.HttpErrorStatus(404)), NoEventHandlers.pipe(T.HttpErrorCode(10068)), ValidationError.pipe(T.HttpErrorCode(10021))],
}));
...
export interface ListworkerversionsResponse {
  result: ({ annotations?: { "workers/message"?: string; "workers/tag"?: string; "workers/triggered_by"?: string }; assets?: { config?: { html_handling?: "auto-trailing-slash" | "force-trailing-slash" | "drop-trailing-slash" | "none"; not_found_handling?: "none" | "404-page" | "single-page-application"; run_worker_first?: unknown }; jwt?: string }; bindings?: ({ name: string; type: "ai" } | { dataset: string; name: string; type: "analytics_engine" } | { name: string; type: "assets" } | { name: string; type: "browser" } | { id: string; name: string; type: "d1" } | { name: string; part: string; type: "data_blob" } | { name: string; namespace: string; outbound?: { params?: string[]; worker?: { environment?: string; service?: string } }; type: "dispatch_namespace" } | { class_name?: string; environment?: string; name: string; namespace_id?: unknown; script_name?: string; type: "durable_object_namespace" } | { id: string; name: string; type: "hyperdrive" } | { name: string; old_name?: string; type: "inherit"; version_id?: string } | { name: string; type: "images" } | { json: string; name: string; type: "json" } | { name: string; namespace_id: string; type: "kv_namespace" } | { certificate_id: string; name: string; type: "mtls_certificate" } | { name: string; text: string; type: "plain_text" } | { name: string; pipeline: string; type: "pipelines" } | { name: string; queue_name: string; type: "queue" } | { bucket_name: string; jurisdiction?: "eu" | "fedramp"; name: string; type: "r2_bucket" } | { name: string; text: string; type: "secret_text" } | { allowed_destination_addresses?: string[]; allowed_sender_addresses?: string[]; destination_address?: string; name: string; type: "send_email" } | { environment?: string; name: string; service: string; type: "service" } | { name: string; part: string; type: "text_blob" } | { index_name: string; name: string; type: "vectorize" } | { name: string; type: "version_metadata" } | { name: string; secret_name: string; store_id: string; type: "secrets_store_secret" } | { algorithm: Record<string, unknown>; format: "raw" | "pkcs8" | "spki" | "jwk"; key_base64?: string; key_jwk?: Record<string, unknown>; name: string; type: "secret_key"; usages: ("encrypt" | "decrypt" | "sign" | "verify" | "deriveKey" | "deriveBits" | "wrapKey" | "unwrapKey")[] } | { class_name?: string; name: string; script_name?: string; type: "workflow"; workflow_name: string } | { name: string; part: string; type: "wasm_module" })[]; compatibility_date?: string; compatibility_flags?: string[]; created_on: string; id: string; limits?: { cpu_ms: number }; main_module?: string; migrations?: unknown; modules?: { content_base64: string; content_type: string; name: string }[]; number: number; placement?: { mode?: "smart" }; source?: string; startup_time_ms?: number; usage_model?: "standard" | "bundled" | "unbound" })[];
  result_info?: { page?: number; per_page?: number; count?: number; total_count?: number; cursor?: string };
}
