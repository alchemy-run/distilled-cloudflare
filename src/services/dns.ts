...
> = API.make(() => ({
  ...
  errors: [RateLimited.pipe(T.HttpErrorCode(971)), TooManyRequests.pipe(T.HttpErrorCode(6100)), AuthenticationError.pipe(T.HttpErrorCode(10000)), InvalidToken.pipe(T.HttpErrorCode(9103)), MissingToken.pipe(T.HttpErrorCode(9106)), TokenExpired.pipe(T.HttpErrorCode(9109)), Unauthorized.pipe(T.HttpErrorCode(9000)), InvalidZone.pipe(T.HttpErrorCode(1003), T.HttpErrorStatus(404))],
}));

export interface CreateDnsRecordRequest {
  zone_id: string;
  body: Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown> | Record<string, unknown>;
}

export const CreateDnsRecordRequest = Schema.Struct({
  zone_id: Schema.String.pipe(T.HttpPath("zone_id")),
  body: Schema.Union(Schema.Union(Schema.Struct({}), Schema.Struct({}), Schema.Struct({}), Schema.Struct({}), Schema.Struct({}), Schema.Struct({}), Schema.Struct({}), Schema.Struct({})), Schema.Union(Schema.Struct({}), Schema.Struct({}), Schema.Struct({}), Schema.Struct({}), Schema.Struct({}), Schema.Struct({}), Schema.Struct({}), Schema.Struct({}), Schema.Struct({}), Schema.Struct({}), Schema.Struct({}), Schema.Struct({}), Schema.Struct({}))).pipe(T.HttpBody())
}).pipe(
...
> = API.make(() => ({
  ...
  errors: [RateLimited.pipe(T.HttpErrorCode(971)), TooManyRequests.pipe(T.HttpErrorCode(6100)), AuthenticationError.pipe(T.HttpErrorCode(10000)), InvalidToken.pipe(T.HttpErrorCode(9103)), MissingToken.pipe(T.HttpErrorCode(9106)), TokenExpired.pipe(T.HttpErrorCode(9109)), Unauthorized.pipe(T.HttpErrorCode(9000)), InvalidZone.pipe(T.HttpErrorCode(1003), T.HttpErrorStatus(404)), ValidationError.pipe(T.HttpErrorCode(10021)), InvalidRequest.pipe(T.HttpErrorCode(6003))],
}));
...
> = API.make(() => ({
  ...
  errors: [RateLimited.pipe(T.HttpErrorCode(971)), TooManyRequests.pipe(T.HttpErrorCode(6100)), AuthenticationError.pipe(T.HttpErrorCode(10000)), InvalidToken.pipe(T.HttpErrorCode(9103)), MissingToken.pipe(T.HttpErrorCode(9106)), TokenExpired.pipe(T.HttpErrorCode(9109)), Unauthorized.pipe(T.HttpErrorCode(9000)), InvalidZone.pipe(T.HttpErrorCode(1003), T.HttpErrorStatus(404)), RecordNotFound.pipe(T.HttpErrorCode(81044), T.HttpErrorStatus(404)), ValidationError.pipe(T.HttpErrorCode(10021))],
}));
...
> = API.make(() => ({
  ...
  errors: [RateLimited.pipe(T.HttpErrorCode(971)), TooManyRequests.pipe(T.HttpErrorCode(6100)), AuthenticationError.pipe(T.HttpErrorCode(10000)), InvalidToken.pipe(T.HttpErrorCode(9103)), MissingToken.pipe(T.HttpErrorCode(9106)), TokenExpired.pipe(T.HttpErrorCode(9109)), Unauthorized.pipe(T.HttpErrorCode(9000)), InvalidZone.pipe(T.HttpErrorCode(1003), T.HttpErrorStatus(404)), RecordNotFound.pipe(T.HttpErrorCode(81044), T.HttpErrorStatus(404))],
}));
