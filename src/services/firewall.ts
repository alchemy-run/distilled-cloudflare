...
export interface CreateFirewallRulesRequest {
  zone_id: string;
  body: { action: { mode?: "simulate" | "ban" | "challenge" | "js_challenge" | "managed_challenge"; response?: { body?: string; content_type?: string }; timeout?: number }; filter: { description?: string; expression?: string; id?: string; paused?: boolean; ref?: string } };
}
...
export const CreateFirewallRulesRequest = Schema.Struct({
  ...
  mode: Schema.optional(Schema.NullOr(Schema.Literal("simulate", "ban", "challenge", "js_challenge", "managed_challenge"))),
  response: Schema.optional(Schema.NullOr(Schema.Union(Schema.Struct({
...
export interface UpdateAFirewallRuleRequest {
  rule_id: string;
  zone_id: string;
  body: { action: { mode?: "simulate" | "ban" | "challenge" | "js_challenge" | "managed_challenge"; response?: { body?: string; content_type?: string }; timeout?: number }; filter: { description?: string; expression?: string; id?: string; paused?: boolean; ref?: string }; id: string };
}
...
export interface UpdateAUserAgentBlockingRuleRequest {
  ua_rule_id: string;
  zone_id: string;
  body: { configuration: { target?: "ip"; value?: string } | { target?: "ip6"; value?: string } | { target?: "ip_range"; value?: string } | { target?: "asn"; value?: string } | { target?: "country"; value?: string }; description?: string; id: string; mode: "block" | "challenge" | "whitelist" | "js_challenge" | "managed_challenge"; paused?: boolean };
}
