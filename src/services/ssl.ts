...
export const ListCertificatePacksResponse = Schema.Struct({
  ...
  certificate_authority: Schema.optional(Schema.Literal("google", "lets_encrypt", "ssl_com")),
  certificates: Schema.Array(Schema.Struct({
  bundle_method: Schema.optional(Schema.String),
  ...
  cloudflare_branding: Schema.optional(Schema.Boolean),
  hosts: Schema.Array(Schema.String),
  id: Schema.String,
  primary_certificate: Schema.optional(Schema.String),
  ...
  validation_method: Schema.optional(Schema.Literal("txt", "http", "email")),
  validation_records: Schema.optional(Schema.Array(Schema.Struct({
  emails: Schema.optional(Schema.Array(Schema.String)),
  http_body: Schema.optional(Schema.String),
  http_url: Schema.optional(Schema.String),
  txt_name: Schema.optional(Schema.String),
  txt_value: Schema.optional(Schema.String)
}))),
  validity_days: Schema.optional(Schema.Literal(14, 30, 90, 365))
})),
  result_info: Schema.optional(Schema.Struct({
    page: Schema.optional(Schema.Number),
    per_page: Schema.optional(Schema.Number),
...
export const GetCertificatePackQuotasResponse = Schema.Struct({
  result: Schema.Struct({
  advanced: Schema.optional(Schema.Struct({
...
export const SslVerificationSslVerificationDetailsResponse = Schema.Struct({
  result: Schema.Array(Schema.Struct({
  brand_check: Schema.optional(Schema.Boolean),
  cert_pack_uuid: Schema.optional(Schema.String),
  ...
  validation_method: Schema.optional(Schema.Literal("http", "cname", "txt")),
  verification_info: Schema.optional(Schema.Struct({
  record_name: Schema.optional(Schema.Literal("record_name", "http_url", "cname", "txt_name")),
  record_target: Schema.optional(Schema.Literal("record_value", "http_body", "cname_target", "txt_value"))
})),
  verification_status: Schema.optional(Schema.Boolean),
  verification_type: Schema.optional(Schema.Literal("cname", "meta tag"))
})),
  result_info: Schema.optional(Schema.Struct({
    page: Schema.optional(Schema.Number),
    per_page: Schema.optional(Schema.Number),
