...
export const AnalyzeCertificateAnalyzeCertificateRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/zones/{zone_id}/ssl/analyze" }))
  .annotations({
    identifier: "AnalyzeCertificateAnalyzeCertificateRequest",
  }) as unknown as Schema.Schema<AnalyzeCertificateAnalyzeCertificateRequest>;
...
export const AnalyzeCertificateAnalyzeCertificateResponse = Schema.Struct({
  ...
  identifier: "AnalyzeCertificateAnalyzeCertificateResponse",
}) as unknown as Schema.Schema<AnalyzeCertificateAnalyzeCertificateResponse>;
...
export interface ListCertificatePacksResponse {
  result: {
    ...
    certificates: {
      ...
      expires_on?: string;
      geo_restrictions?: { label?: "us" | "eu" | "highest_security" };
      hosts: string[];
      id: string;
      issuer?: string;
      modified_on?: string;
...
export const ListCertificatePacksResponse = Schema.Struct({
  result: Schema.Array(
    Schema.Struct({
      certificate_authority: Schema.optional(
        Schema.NullOr(Schema.Literal("google", "lets_encrypt", "ssl_com")),
      ),
      certificates: Schema.Array(
        Schema.Struct({
          ...
          geo_restrictions: Schema.optional(
            Schema.NullOr(
              Schema.Struct({
                label: Schema.optional(
                  Schema.NullOr(Schema.Literal("us", "eu", "highest_security")),
                ),
              }),
            ),
          ),
      ...
      validation_records: Schema.optional(
        Schema.NullOr(
          Schema.Array(
            Schema.Struct({
...
export const CertificatePacksOrderAdvancedCertificateManagerCertificatePackRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/zones/{zone_id}/ssl/certificate_packs/order" }))
  .annotations({
    identifier: "CertificatePacksOrderAdvancedCertificateManagerCertificatePackRequest",
  }) as unknown as Schema.Schema<CertificatePacksOrderAdvancedCertificateManagerCertificatePackRequest>;
...
export const CertificatePacksOrderAdvancedCertificateManagerCertificatePackResponse = Schema.Struct(
  ...
  identifier: "CertificatePacksOrderAdvancedCertificateManagerCertificatePackResponse",
}) as unknown as Schema.Schema<CertificatePacksOrderAdvancedCertificateManagerCertificatePackResponse>;
...
export const GetCertificatePackQuotasRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/ssl/certificate_packs/quota" }))
  .annotations({
    identifier: "GetCertificatePackQuotasRequest",
  }) as unknown as Schema.Schema<GetCertificatePackQuotasRequest>;
...
export const GetCertificatePackQuotasResponse = Schema.Struct({
  ...
  identifier: "GetCertificatePackQuotasResponse",
}) as unknown as Schema.Schema<GetCertificatePackQuotasResponse>;
...
export const DeleteAdvancedCertificateManagerCertificatePackRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "DeleteAdvancedCertificateManagerCertificatePackRequest",
  }) as unknown as Schema.Schema<DeleteAdvancedCertificateManagerCertificatePackRequest>;
...
export const DeleteAdvancedCertificateManagerCertificatePackResponse = Schema.Struct({
  ...
  identifier: "DeleteAdvancedCertificateManagerCertificatePackResponse",
}) as unknown as Schema.Schema<DeleteAdvancedCertificateManagerCertificatePackResponse>;
...
export const CertificatePacksRestartValidationForAdvancedCertificateManagerCertificatePackRequest =
  Schema.Struct({
    certificate_pack_id: Schema.String.pipe(T.HttpPath("certificate_pack_id")),
    zone_id: Schema.String.pipe(T.HttpPath("zone_id")),
    body: Schema.Struct({
    ...
    }) as unknown as Schema.Schema<CertificatePacksRestartValidationForAdvancedCertificateManagerCertificatePackRequest>;
...
export const CertificatePacksRestartValidationForAdvancedCertificateManagerCertificatePackResponse =
  Schema.Struct({
    result: Schema.Struct({
      certificate_authority: Schema.optional(
        Schema.NullOr(Schema.Literal("google", "lets_encrypt", "ssl_com")),
  ...
  }) as unknown as Schema.Schema<CertificatePacksRestartValidationForAdvancedCertificateManagerCertificatePackResponse>;
...
export const SslTlsModeRecommendationSslTlsRecommendationRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "SslTlsModeRecommendationSslTlsRecommendationRequest",
  }) as unknown as Schema.Schema<SslTlsModeRecommendationSslTlsRecommendationRequest>;
...
export const SslTlsModeRecommendationSslTlsRecommendationResponse = Schema.Struct({
  ...
  identifier: "SslTlsModeRecommendationSslTlsRecommendationResponse",
}) as unknown as Schema.Schema<SslTlsModeRecommendationSslTlsRecommendationResponse>;
...
export const UniversalSslSettingsForAZoneUniversalSslSettingsDetailsRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "UniversalSslSettingsForAZoneUniversalSslSettingsDetailsRequest",
  }) as unknown as Schema.Schema<UniversalSslSettingsForAZoneUniversalSslSettingsDetailsRequest>;
...
export const UniversalSslSettingsForAZoneUniversalSslSettingsDetailsResponse = Schema.Struct({
  ...
  identifier: "UniversalSslSettingsForAZoneUniversalSslSettingsDetailsResponse",
}) as unknown as Schema.Schema<UniversalSslSettingsForAZoneUniversalSslSettingsDetailsResponse>;
...
export const UniversalSslSettingsForAZoneEditUniversalSslSettingsRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "PATCH", path: "/zones/{zone_id}/ssl/universal/settings" }))
  .annotations({
    identifier: "UniversalSslSettingsForAZoneEditUniversalSslSettingsRequest",
  }) as unknown as Schema.Schema<UniversalSslSettingsForAZoneEditUniversalSslSettingsRequest>;
...
export const UniversalSslSettingsForAZoneEditUniversalSslSettingsResponse = Schema.Struct({
  ...
  identifier: "UniversalSslSettingsForAZoneEditUniversalSslSettingsResponse",
}) as unknown as Schema.Schema<UniversalSslSettingsForAZoneEditUniversalSslSettingsResponse>;
...
export const SslVerificationSslVerificationDetailsRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "SslVerificationSslVerificationDetailsRequest",
  }) as unknown as Schema.Schema<SslVerificationSslVerificationDetailsRequest>;
...
export const SslVerificationSslVerificationDetailsResponse = Schema.Struct({
  result: Schema.Array(
    Schema.Struct({
      ...
      certificate_status: Schema.Literal(
        "initializing",
        "authorizing",
        "active",
        "expired",
      ...
      signature: Schema.optional(
        Schema.NullOr(Schema.Literal("ECDSAWithSHA256", "SHA1WithRSA", "SHA256WithRSA")),
      ),
      validation_method: Schema.optional(Schema.NullOr(Schema.Literal("http", "cname", "txt"))),
      verification_info: Schema.optional(
        Schema.NullOr(
          Schema.Struct({
            record_name: Schema.optional(
              Schema.NullOr(Schema.Literal("record_name", "http_url", "cname", "txt_name")),
            ),
            record_target: Schema.optional(
              Schema.NullOr(
  ...
  identifier: "SslVerificationSslVerificationDetailsResponse",
}) as unknown as Schema.Schema<SslVerificationSslVerificationDetailsResponse>;
...
export const SslVerificationEditSslCertificatePackValidationMethodRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "SslVerificationEditSslCertificatePackValidationMethodRequest",
  }) as unknown as Schema.Schema<SslVerificationEditSslCertificatePackValidationMethodRequest>;
...
export const SslVerificationEditSslCertificatePackValidationMethodResponse = Schema.Struct({
  ...
  identifier: "SslVerificationEditSslCertificatePackValidationMethodResponse",
}) as unknown as Schema.Schema<SslVerificationEditSslCertificatePackValidationMethodResponse>;
