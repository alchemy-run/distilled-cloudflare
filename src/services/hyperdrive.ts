...
export interface CreateHyperdriveRequest {
  account_id: string;
  body: { caching?: Record<string, unknown> | Record<string, unknown>; created_on?: string; id: string; modified_on?: string; mtls?: { ca_certificate_id?: string; mtls_certificate_id?: string; sslmode?: string }; name: string; origin: unknown | unknown; origin_connection_limit?: number };
}
...
export interface PatchHyperdriveRequest {
  account_id: string;
  hyperdrive_id: string;
  body: { caching?: Record<string, unknown> | Record<string, unknown>; mtls?: { ca_certificate_id?: string; mtls_certificate_id?: string; sslmode?: string }; name?: string; origin?: { database?: string; password?: string; scheme?: "postgres" | "postgresql" | "mysql"; user?: string } | unknown; origin_connection_limit?: number };
}
...
export const PatchHyperdriveRequest = Schema.Struct({
  ...
  origin: Schema.optional(Schema.NullOr(Schema.Union(Schema.Struct({
  database: Schema.optional(Schema.NullOr(Schema.String)),
  password: Schema.optional(Schema.NullOr(Schema.String)),
  scheme: Schema.optional(Schema.NullOr(Schema.Literal("postgres", "postgresql", "mysql"))),
