...
).annotations({ identifier: "ListDatabasesRequest" }) as unknown as Schema.Schema<ListDatabasesRequest>;
...
}).annotations({ identifier: "ListDatabasesResponse" }) as unknown as Schema.Schema<ListDatabasesResponse>;
...
export interface CreateDatabaseRequest {
  account_id: string;
  body: { jurisdiction?: "eu" | "fedramp"; name: string; primary_location_hint?: "wnam" | "enam" | "weur" | "eeur" | "apac" | "oc" };
}
...
).annotations({ identifier: "CreateDatabaseRequest" }) as unknown as Schema.Schema<CreateDatabaseRequest>;

export interface CreateDatabaseResponse {
  result: { created_at?: string; file_size?: number; name?: string; num_tables?: number; read_replication?: { mode: "auto" | "disabled" }; uuid?: string; version?: string };
  result_info?: { page?: number; per_page?: number; count?: number; total_count?: number; cursor?: string };
}
...
}).annotations({ identifier: "CreateDatabaseResponse" }) as unknown as Schema.Schema<CreateDatabaseResponse>;
...
export const GetDatabaseRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "/accounts/{account_id}/d1/database/{database_id}" }),
).annotations({ identifier: "GetDatabaseRequest" }) as unknown as Schema.Schema<GetDatabaseRequest>;
...
}).annotations({ identifier: "GetDatabaseResponse" }) as unknown as Schema.Schema<GetDatabaseResponse>;
...
export const UpdateDatabaseRequest = Schema.Struct({
  ...
  T.Http({ method: "PUT", path: "/accounts/{account_id}/d1/database/{database_id}" }),
).annotations({ identifier: "UpdateDatabaseRequest" }) as unknown as Schema.Schema<UpdateDatabaseRequest>;
...
}).annotations({ identifier: "UpdateDatabaseResponse" }) as unknown as Schema.Schema<UpdateDatabaseResponse>;
...
export const DeleteDatabaseRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "/accounts/{account_id}/d1/database/{database_id}" }),
).annotations({ identifier: "DeleteDatabaseRequest" }) as unknown as Schema.Schema<DeleteDatabaseRequest>;
...
}).annotations({ identifier: "DeleteDatabaseResponse" }) as unknown as Schema.Schema<DeleteDatabaseResponse>;
...
).annotations({ identifier: "UpdatePartialDatabaseRequest" }) as unknown as Schema.Schema<UpdatePartialDatabaseRequest>;
...
}).annotations({ identifier: "UpdatePartialDatabaseResponse" }) as unknown as Schema.Schema<UpdatePartialDatabaseResponse>;
...
export interface CloudflareD1ExportDatabaseRequest {
  account_id: string;
  database_id: string;
  body: { current_bookmark?: string; dump_options?: { no_data?: boolean; no_schema?: boolean; tables?: string[] }; output_format: "polling" };
}
...
export const CloudflareD1ExportDatabaseRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/accounts/{account_id}/d1/database/{database_id}/export" }),
).annotations({ identifier: "CloudflareD1ExportDatabaseRequest" }) as unknown as Schema.Schema<CloudflareD1ExportDatabaseRequest>;

export interface CloudflareD1ExportDatabaseResponse {
  result: { at_bookmark?: string; error?: string; messages?: string[]; result?: { filename?: string; signed_url?: string }; status?: "complete" | "error"; success?: boolean; type?: "export" };
  result_info?: { page?: number; per_page?: number; count?: number; total_count?: number; cursor?: string };
}
...
}).annotations({ identifier: "CloudflareD1ExportDatabaseResponse" }) as unknown as Schema.Schema<CloudflareD1ExportDatabaseResponse>;
...
export const CloudflareD1ImportDatabaseRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/accounts/{account_id}/d1/database/{database_id}/import" }),
).annotations({ identifier: "CloudflareD1ImportDatabaseRequest" }) as unknown as Schema.Schema<CloudflareD1ImportDatabaseRequest>;

export interface CloudflareD1ImportDatabaseResponse {
  result: { at_bookmark?: string; error?: string; filename?: string; messages?: string[]; result?: { final_bookmark?: string; meta?: { changed_db?: boolean; changes?: number; duration?: number; last_row_id?: number; rows_read?: number; rows_written?: number; served_by_colo?: string; served_by_primary?: boolean; served_by_region?: "WNAM" | "ENAM" | "WEUR" | "EEUR" | "APAC" | "OC"; size_after?: number; timings?: { sql_duration_ms?: number } }; num_queries?: number }; status?: "complete" | "error"; success?: boolean; type?: "import"; upload_url?: string };
  result_info?: { page?: number; per_page?: number; count?: number; total_count?: number; cursor?: string };
}
...
}).annotations({ identifier: "CloudflareD1ImportDatabaseResponse" }) as unknown as Schema.Schema<CloudflareD1ImportDatabaseResponse>;
...
).annotations({ identifier: "CloudflareD1QueryDatabaseRequest" }) as unknown as Schema.Schema<CloudflareD1QueryDatabaseRequest>;

export interface CloudflareD1QueryDatabaseResponse {
  result: { meta?: { changed_db?: boolean; changes?: number; duration?: number; last_row_id?: number; rows_read?: number; rows_written?: number; served_by_colo?: string; served_by_primary?: boolean; served_by_region?: "WNAM" | "ENAM" | "WEUR" | "EEUR" | "APAC" | "OC"; size_after?: number; timings?: { sql_duration_ms?: number } }; results?: Record<string, unknown>[]; success?: boolean }[];
  result_info?: { page?: number; per_page?: number; count?: number; total_count?: number; cursor?: string };
}
...
}).annotations({ identifier: "CloudflareD1QueryDatabaseResponse" }) as unknown as Schema.Schema<CloudflareD1QueryDatabaseResponse>;
...
).annotations({ identifier: "CloudflareD1RawDatabaseQueryRequest" }) as unknown as Schema.Schema<CloudflareD1RawDatabaseQueryRequest>;

export interface CloudflareD1RawDatabaseQueryResponse {
  result: { meta?: { changed_db?: boolean; changes?: number; duration?: number; last_row_id?: number; rows_read?: number; rows_written?: number; served_by_colo?: string; served_by_primary?: boolean; served_by_region?: "WNAM" | "ENAM" | "WEUR" | "EEUR" | "APAC" | "OC"; size_after?: number; timings?: { sql_duration_ms?: number } }; results?: { columns?: string[]; rows?: unknown[][] }; success?: boolean }[];
  result_info?: { page?: number; per_page?: number; count?: number; total_count?: number; cursor?: string };
}
...
}).annotations({ identifier: "CloudflareD1RawDatabaseQueryResponse" }) as unknown as Schema.Schema<CloudflareD1RawDatabaseQueryResponse>;
...
export const GetBookmarkRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "/accounts/{account_id}/d1/database/{database_id}/time_travel/bookmark" }),
).annotations({ identifier: "GetBookmarkRequest" }) as unknown as Schema.Schema<GetBookmarkRequest>;
...
}).annotations({ identifier: "GetBookmarkResponse" }) as unknown as Schema.Schema<GetBookmarkResponse>;
...
export const CloudflareD1TimeTravelRestoreRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/accounts/{account_id}/d1/database/{database_id}/time_travel/restore" }),
).annotations({ identifier: "CloudflareD1TimeTravelRestoreRequest" }) as unknown as Schema.Schema<CloudflareD1TimeTravelRestoreRequest>;
...
}).annotations({ identifier: "CloudflareD1TimeTravelRestoreResponse" }) as unknown as Schema.Schema<CloudflareD1TimeTravelRestoreResponse>;
