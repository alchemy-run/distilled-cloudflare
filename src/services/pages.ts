...
export const GetProjectsResponse = Schema.Struct({
  ...
  env_vars: Schema.NullOr(Schema.Record({ key: Schema.String, value: Schema.Union(Schema.Struct({
...
export const CreateProjectRequest = Schema.Struct({
  ...
  env_vars: Schema.optional(Schema.NullOr(Schema.Record({ key: Schema.String, value: Schema.Union(Schema.Struct({
  type: Schema.Literal("plain_text"),
  value: Schema.String
}), Schema.Struct({
  type: Schema.Literal("secret_text"),
