...
export interface GetProjectsResponse {
  result: {
    ...
    canonical_deployment: unknown;
    created_on: string;
    deployment_configs: { preview: unknown; production: unknown };
    domains?: string[];
    framework: string;
    ...
    Schema.Struct({
      ...
      deployment_configs: Schema.Struct({
        preview: Schema.Struct({
          ...
          analytics_engine_datasets: Schema.optional(
            Schema.NullOr(
              Schema.Record({
                key: Schema.String,
                value: Schema.Struct({
          ...
          durable_object_namespaces: Schema.optional(
            Schema.NullOr(
              Schema.Record({
                key: Schema.String,
                value: Schema.Struct({
          ...
          mtls_certificates: Schema.optional(
            Schema.NullOr(
              Schema.Record({
                key: Schema.String,
                value: Schema.Struct({
          ...
          queue_producers: Schema.optional(
            Schema.NullOr(
              Schema.Record({
                key: Schema.String,
                value: Schema.Struct({
          ...
          vectorize_bindings: Schema.optional(
            Schema.NullOr(
              Schema.Record({
                key: Schema.String,
                value: Schema.Struct({
...
}) as unknown as Schema.Schema<GetProjectsResponse>;
...
export const CreateProjectRequest = Schema.Struct({
  ...
  body: Schema.Struct({
    ...
    deployment_configs: Schema.optional(
      Schema.NullOr(
        Schema.Struct({
          preview: Schema.optional(
            Schema.NullOr(
              Schema.Struct({
                ...
                always_use_latest_compatibility_date: Schema.optional(
                ...
                usage_model: Schema.optional(
                  Schema.NullOr(Schema.Literal("standard", "bundled", "unbound")),
                ),
                vectorize_bindings: Schema.optional(
                  Schema.NullOr(
                    Schema.Record({
      ...
      Schema.NullOr(
        Schema.Struct({
          config: Schema.Struct({
            ...
            preview_deployment_setting: Schema.optional(
              Schema.NullOr(Schema.Literal("all", "none", "custom")),
            ),
  ...
  .pipe(T.Http({ method: "POST", path: "/accounts/{account_id}/pages/projects" }))
  .annotations({
...
export const GetProjectRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/pages/projects/{project_name}" }))
...
export const DeleteProjectRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "DELETE", path: "/accounts/{account_id}/pages/projects/{project_name}" }))
  .annotations({
...
export const UpdateProjectRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "PATCH", path: "/accounts/{account_id}/pages/projects/{project_name}" }))
  .annotations({
    identifier: "UpdateProjectRequest",
  }) as unknown as Schema.Schema<UpdateProjectRequest>;
...
}) as unknown as Schema.Schema<UpdateProjectResponse>;
...
}) as unknown as Schema.Schema<GetDeploymentsResponse>;
...
export const GetDeploymentInfoRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "GetDeploymentInfoRequest",
  }) as unknown as Schema.Schema<GetDeploymentInfoRequest>;
...
export const GetDeploymentInfoResponse = Schema.Struct({
  ...
  identifier: "GetDeploymentInfoResponse",
}) as unknown as Schema.Schema<GetDeploymentInfoResponse>;
...
export const GetDeploymentLogsRequest = Schema.Struct({
  ...
  }) as unknown as Schema.Schema<GetDeploymentLogsRequest>;
...
}) as unknown as Schema.Schema<GetDeploymentLogsResponse>;
...
export const PagesDeploymentRetryDeploymentRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "PagesDeploymentRetryDeploymentRequest",
  }) as unknown as Schema.Schema<PagesDeploymentRetryDeploymentRequest>;
...
export const PagesDeploymentRetryDeploymentResponse = Schema.Struct({
  ...
  identifier: "PagesDeploymentRetryDeploymentResponse",
}) as unknown as Schema.Schema<PagesDeploymentRetryDeploymentResponse>;
...
export const PagesDeploymentRollbackDeploymentRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "PagesDeploymentRollbackDeploymentRequest",
  }) as unknown as Schema.Schema<PagesDeploymentRollbackDeploymentRequest>;
...
export const PagesDeploymentRollbackDeploymentResponse = Schema.Struct({
  ...
  identifier: "PagesDeploymentRollbackDeploymentResponse",
}) as unknown as Schema.Schema<PagesDeploymentRollbackDeploymentResponse>;
...
}) as unknown as Schema.Schema<GetDomainsResponse>;
...
export const PagesDomainsAddDomainRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "PagesDomainsAddDomainRequest",
  }) as unknown as Schema.Schema<PagesDomainsAddDomainRequest>;
...
export const PagesDomainsAddDomainResponse = Schema.Struct({
  ...
  identifier: "PagesDomainsAddDomainResponse",
}) as unknown as Schema.Schema<PagesDomainsAddDomainResponse>;
...
export const PatchDomainRequest = Schema.Struct({
  ...
  }) as unknown as Schema.Schema<PatchDomainRequest>;
...
}) as unknown as Schema.Schema<PatchDomainResponse>;
...
export const PagesPurgeBuildCacheRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "PagesPurgeBuildCacheRequest",
  }) as unknown as Schema.Schema<PagesPurgeBuildCacheRequest>;
...
export const PagesPurgeBuildCacheResponse = Schema.Struct({
  ...
  identifier: "PagesPurgeBuildCacheResponse",
}) as unknown as Schema.Schema<PagesPurgeBuildCacheResponse>;
