...
export const GetWorkflowDetailsRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "GetWorkflowDetailsRequest",
  }) as unknown as Schema.Schema<GetWorkflowDetailsRequest>;
...
export const GetWorkflowDetailsResponse = Schema.Struct({
  result: Schema.Struct({
    ...
    name: Schema.String,
    script_name: Schema.String,
    triggered_on: Schema.optional(Schema.NullOr(Schema.Date)),
  }),
  result_info: Schema.optional(
    Schema.Struct({
      page: Schema.optional(Schema.Number),
  ...
  identifier: "GetWorkflowDetailsResponse",
}) as unknown as Schema.Schema<GetWorkflowDetailsResponse>;
...
export const CreateOrModifyWorkflowRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "PUT", path: "/accounts/{account_id}/workflows/{workflow_name}" }))
  .annotations({
    identifier: "CreateOrModifyWorkflowRequest",
  }) as unknown as Schema.Schema<CreateOrModifyWorkflowRequest>;
...
export const CreateOrModifyWorkflowResponse = Schema.Struct({
  result: Schema.Struct({
    ...
    created_on: Schema.Date,
    id: Schema.UUID,
    is_deleted: Schema.optional(Schema.NullOr(Schema.Number)),
    modified_on: Schema.Date,
    name: Schema.String,
    script_name: Schema.String,
    terminator_running: Schema.optional(Schema.NullOr(Schema.Number)),
    triggered_on: Schema.optional(Schema.NullOr(Schema.Date)),
  ...
  identifier: "CreateOrModifyWorkflowResponse",
}) as unknown as Schema.Schema<CreateOrModifyWorkflowResponse>;
...
export const ListWorkflowInstancesRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "ListWorkflowInstancesRequest",
  }) as unknown as Schema.Schema<ListWorkflowInstancesRequest>;
...
export const ListWorkflowInstancesResponse = Schema.Struct({
  ...
  identifier: "ListWorkflowInstancesResponse",
}) as unknown as Schema.Schema<ListWorkflowInstancesResponse>;
...
export interface CreateNewWorkflowInstanceRequest {
  ...
  body: {
    instance_id?: string;
    instance_retention?: { error_retention?: unknown; success_retention?: unknown };
...
export const CreateNewWorkflowInstanceRequest = Schema.Struct({
  ...
  body: Schema.Struct({
    ...
    instance_retention: Schema.optional(
      Schema.NullOr(
        Schema.Struct({
          error_retention: Schema.optional(
            Schema.NullOr(Schema.Union(Schema.Number, Schema.String)),
          ),
          success_retention: Schema.optional(
            Schema.NullOr(Schema.Union(Schema.Number, Schema.String)),
          ),
        }),
      ),
  ...
  .annotations({
    identifier: "CreateNewWorkflowInstanceRequest",
  }) as unknown as Schema.Schema<CreateNewWorkflowInstanceRequest>;
...
export const CreateNewWorkflowInstanceResponse = Schema.Struct({
  ...
  identifier: "CreateNewWorkflowInstanceResponse",
}) as unknown as Schema.Schema<CreateNewWorkflowInstanceResponse>;
...
export const CreateWorkflowInstanceRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "CreateWorkflowInstanceRequest",
  }) as unknown as Schema.Schema<CreateWorkflowInstanceRequest>;
...
export const CreateWorkflowInstanceResponse = Schema.Struct({
  ...
  identifier: "CreateWorkflowInstanceResponse",
}) as unknown as Schema.Schema<CreateWorkflowInstanceResponse>;
...
export const WorBatchTerminateWorkflowInstancesRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "WorBatchTerminateWorkflowInstancesRequest",
  }) as unknown as Schema.Schema<WorBatchTerminateWorkflowInstancesRequest>;
...
export const WorBatchTerminateWorkflowInstancesResponse = Schema.Struct({
  ...
  identifier: "WorBatchTerminateWorkflowInstancesResponse",
}) as unknown as Schema.Schema<WorBatchTerminateWorkflowInstancesResponse>;
...
export const WorStatusTerminateWorkflowInstancesRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "WorStatusTerminateWorkflowInstancesRequest",
  }) as unknown as Schema.Schema<WorStatusTerminateWorkflowInstancesRequest>;
...
export const WorStatusTerminateWorkflowInstancesResponse = Schema.Struct({
  ...
  identifier: "WorStatusTerminateWorkflowInstancesResponse",
}) as unknown as Schema.Schema<WorStatusTerminateWorkflowInstancesResponse>;
...
export const WorDescribeWorkflowInstanceRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "WorDescribeWorkflowInstanceRequest",
  }) as unknown as Schema.Schema<WorDescribeWorkflowInstanceRequest>;
...
export const WorDescribeWorkflowInstanceResponse = Schema.Struct({
          ...
          config: Schema.Struct({
            retries: Schema.Struct({
              backoff: Schema.optional(
                Schema.NullOr(Schema.Literal("constant", "linear", "exponential")),
              ),
  ...
  identifier: "WorDescribeWorkflowInstanceResponse",
}) as unknown as Schema.Schema<WorDescribeWorkflowInstanceResponse>;
...
export const WorSendEventWorkflowInstanceRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "WorSendEventWorkflowInstanceRequest",
  }) as unknown as Schema.Schema<WorSendEventWorkflowInstanceRequest>;
...
export const WorSendEventWorkflowInstanceResponse = Schema.Struct({
  ...
  identifier: "WorSendEventWorkflowInstanceResponse",
}) as unknown as Schema.Schema<WorSendEventWorkflowInstanceResponse>;
...
export const WorChangeStatusWorkflowInstanceRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "WorChangeStatusWorkflowInstanceRequest",
  }) as unknown as Schema.Schema<WorChangeStatusWorkflowInstanceRequest>;
...
export const WorChangeStatusWorkflowInstanceResponse = Schema.Struct({
  ...
  identifier: "WorChangeStatusWorkflowInstanceResponse",
}) as unknown as Schema.Schema<WorChangeStatusWorkflowInstanceResponse>;
...
export const ListWorkflowVersionsRequest = Schema.Struct({
  ...
  }) as unknown as Schema.Schema<ListWorkflowVersionsRequest>;
...
}) as unknown as Schema.Schema<ListWorkflowVersionsResponse>;
...
export const WorDescribeWorkflowVersionsRequest = Schema.Struct({
  ...
  .annotations({
    identifier: "WorDescribeWorkflowVersionsRequest",
  }) as unknown as Schema.Schema<WorDescribeWorkflowVersionsRequest>;
...
export const WorDescribeWorkflowVersionsResponse = Schema.Struct({
  ...
  identifier: "WorDescribeWorkflowVersionsResponse",
}) as unknown as Schema.Schema<WorDescribeWorkflowVersionsResponse>;
