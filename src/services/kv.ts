...
> = API.make(() => ({
  ...
  errors: [RateLimited.pipe(T.HttpErrorCode(971)), TooManyRequests.pipe(T.HttpErrorCode(6100)), AuthenticationError.pipe(T.HttpErrorCode(10000)), InvalidToken.pipe(T.HttpErrorCode(9103)), MissingToken.pipe(T.HttpErrorCode(9106)), TokenExpired.pipe(T.HttpErrorCode(9109)), Unauthorized.pipe(T.HttpErrorCode(9000)), NamespaceNotFound.pipe(T.HttpErrorCode(10013), T.HttpErrorStatus(404))],
}));
...
export const workersKvNamespaceRenameANamespace: (
  ...
  RateLimited | TooManyRequests | AuthenticationError | InvalidToken | MissingToken | TokenExpired | Unauthorized | NamespaceNotFound | NamespaceNameRequired | CloudflareError | UnknownCloudflareError | CloudflareNetworkError | CloudflareHttpError,
  ApiToken | HttpClient.HttpClient
> = API.make(() => ({
  input: WorkersKvNamespaceRenameANamespaceRequest,
  output: WorkersKvNamespaceRenameANamespaceResponse,
  errors: [RateLimited.pipe(T.HttpErrorCode(971)), TooManyRequests.pipe(T.HttpErrorCode(6100)), AuthenticationError.pipe(T.HttpErrorCode(10000)), InvalidToken.pipe(T.HttpErrorCode(9103)), MissingToken.pipe(T.HttpErrorCode(9106)), TokenExpired.pipe(T.HttpErrorCode(9109)), Unauthorized.pipe(T.HttpErrorCode(9000)), NamespaceNotFound.pipe(T.HttpErrorCode(10013), T.HttpErrorStatus(404)), NamespaceNameRequired.pipe(T.HttpErrorCode(10019))],
}));
...
export const workersKvNamespaceWriteMultipleKeyValuePairs: (
  ...
  RateLimited | TooManyRequests | AuthenticationError | InvalidToken | MissingToken | TokenExpired | Unauthorized | NamespaceNotFound | ValidationError | CloudflareError | UnknownCloudflareError | CloudflareNetworkError | CloudflareHttpError,
  ApiToken | HttpClient.HttpClient
> = API.make(() => ({
  input: WorkersKvNamespaceWriteMultipleKeyValuePairsRequest,
  output: WorkersKvNamespaceWriteMultipleKeyValuePairsResponse,
  errors: [RateLimited.pipe(T.HttpErrorCode(971)), TooManyRequests.pipe(T.HttpErrorCode(6100)), AuthenticationError.pipe(T.HttpErrorCode(10000)), InvalidToken.pipe(T.HttpErrorCode(9103)), MissingToken.pipe(T.HttpErrorCode(9106)), TokenExpired.pipe(T.HttpErrorCode(9109)), Unauthorized.pipe(T.HttpErrorCode(9000)), NamespaceNotFound.pipe(T.HttpErrorCode(10013), T.HttpErrorStatus(404)), ValidationError.pipe(T.HttpErrorCode(10021))],
}));
